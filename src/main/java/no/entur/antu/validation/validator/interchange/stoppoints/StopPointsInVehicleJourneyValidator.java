...
/**
 * Validates that the stop points in interchange are part of the journey in interchange.
 */
public class StopPointsInVehicleJourneyValidator extends AntuNetexValidator {
  ...
  private void validateStopPoint(
    ...
    if (
      context
        .scheduledStopPointIdsForFromJourneyRef()
        .stream()
    ...
    if (
      context
        .scheduledStopPointIdsForToJourneyRef()
        .stream()
