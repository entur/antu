      ...
      if (distance > (3 * INTERCHANGE_EXPECTED_DISTANCE)) {
        reportError.accept(
          new UnexpectedInterchangeDistanceError(
            UnexpectedInterchangeDistanceError.RuleCode.DISTANCE_BETWEEN_STOP_POINTS_IN_INTERCHANGE_IS_MORE_THAN_MAX,
        ...
        reportError.accept(
          new UnexpectedInterchangeDistanceError(
            UnexpectedInterchangeDistanceError.RuleCode.DISTANCE_BETWEEN_STOP_POINTS_IN_INTERCHANGE_IS_MORE_THAN_WARN,
            distanceContext.interchangeId(),
            antuNetexData.stopPointName(
              distanceContext.fromStopPointCoordinates().scheduledStopPointId()
            ),
