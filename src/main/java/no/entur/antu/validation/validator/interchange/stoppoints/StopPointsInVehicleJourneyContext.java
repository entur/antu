...
public record StopPointsInVehicleJourneyContext(
  ...
  String toJourneyRef,
  List<ScheduledStopPointId> scheduledStopPointIdsForFromJourneyRef,
  List<ScheduledStopPointId> scheduledStopPointIdsForToJourneyRef
) {
  public static StopPointsInVehicleJourneyContext of(
    ...
    return new StopPointsInVehicleJourneyContext(
      ...
      Optional
        .ofNullable(serviceJourneyInterchange.getFromJourneyRef())
        .map(antuNetexData::scheduledStopPoints)
        .orElse(null),
      Optional
        .ofNullable(serviceJourneyInterchange.getToJourneyRef())
        .map(antuNetexData::scheduledStopPoints)
  ...
  public boolean isValid() {
    return (
      ...
      fromJourneyRef != null &&
      toJourneyRef != null &&
      scheduledStopPointIdsForFromJourneyRef != null &&
      scheduledStopPointIdsForToJourneyRef != null
    );
  }
}
