 ...
 * it is an error.
 */
public class IdenticalStopPoints extends AntuNetexValidator {

  private static final Logger LOGGER = LoggerFactory.getLogger(
    IdenticalStopPoints.class
  );

  public IdenticalStopPoints(
      ...
      .forEach(entry ->
        addValidationReportEntry(
          ...
          new IdenticalStopPointsError(
            IdenticalStopPointsError.RuleCode.IDENTICAL_JOURNEY_PATTERNS,
            entry
              .getValue()
              .stream()
