 ...
 */
public class LineRefOnGroupOfLinesIgnorer implements ExternalReferenceValidator {
    ...
    private Set<IdVersion> isOfSupportedTypes(Set<IdVersion> references) {
        ...
        for (IdVersion ref : references) {
            if (("LineRef".equals(ref.getElementName()) && ref.getParentElementNames().contains("GroupOfLines"))) {
