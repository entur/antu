 ...
 */
public class RedisSwedenStopPlaceNetexIdRepository implements SwedenStopPlaceNetexIdRepository {

    private static final String SHARED_STOP_PLACE_ID_SET_PREFIX = "SHARED_STOP_PLACE_ID_SET_";
    public static final String STOP_PLACE_ID_SET_SEMAPHORE_PREFIX = "SWEDEN_STOP_PLACE_SET_SEMAPHORE_";
    ...
    @Override
    public void addSharedStopPlaceAndQuayIds(String reportId, Set<String> stopPlaceAndQuayIds) {
        redissonClient.getSet(getStopPlaceIdCacheKey(reportId)).addAll(stopPlaceAndQuayIds);
        RSemaphore semaphore = redissonClient.getSemaphore(STOP_PLACE_ID_SET_SEMAPHORE_PREFIX + reportId);
