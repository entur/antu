...
public class CacheConfig {
  ...
  public static final String SERVICE_JOURNEY_TO_SCHEDULED_STOP_POINTS_CACHE =
  ...
  @Bean(name = SERVICE_JOURNEY_TO_SCHEDULED_STOP_POINTS_CACHE)
  public Map<String, Map<String, List<String>>> serviceJourneyToScheduledStopPointsCache(
    RedissonClient redissonClient
  ) {
    return redissonClient.getLocalCachedMap(
