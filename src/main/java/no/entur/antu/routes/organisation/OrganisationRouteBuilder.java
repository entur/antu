...
public class OrganisationRouteBuilder extends BaseRouteBuilder {
    ...
    public OrganisationRouteBuilder(@Value("${antu.organisation.refresh.interval:trigger.repeatInterval=300000&trigger.repeatCount=-1&startDelayedSeconds=10&stateful=true}") String quartzTrigger) {
        super();
