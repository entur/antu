...
public class CommonFilesBarrierRouteBuilder extends BaseRouteBuilder {
    ...
    public void configure() throws Exception {
        ...
        from("master:lockOnAntuCommonFilesAggregationQueue:google-pubsub:{{antu.pubsub.project.id}}:AntuCommonFilesAggregationQueue")
                ...
                .aggregate(header(VALIDATION_REPORT_ID_HEADER)).aggregationStrategy(new CommonFilesAggregationStrategy()).completionTimeout(1800000)
     ...
     */
    private static class CommonFilesAggregationStrategy extends AntuGroupedMessageAggregationStrategy {
        ...
        public Exchange aggregate(Exchange oldExchange, Exchange newExchange) {
            ...
            if (nbCommonFiles == null) {
                throw new AntuException("Header not found: " + DATASET_NB_COMMON_FILES + " for validation report " + newExchange.getIn().getHeader(VALIDATION_REPORT_ID_HEADER) + " and codespace " + newExchange.getIn().getHeader(DATASET_CODESPACE));
            }
