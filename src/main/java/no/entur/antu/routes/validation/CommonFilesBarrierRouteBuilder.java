...
public class CommonFilesBarrierRouteBuilder extends BaseRouteBuilder {
  ...
  public void configure() throws Exception {
    ...
    from("direct:createLineFilesValidationJobs")
      ...
      .log(
        LoggingLevel.DEBUG,
        correlation() + "Creating validation job for file ${body}"
      )
   ...
   */
  private static class CommonFilesAggregationStrategy
    ...
    public Exchange aggregate(Exchange oldExchange, Exchange newExchange) {
      ...
      Long nbCommonFiles = newExchange
        .getIn()
        .getHeader(DATASET_NB_COMMON_FILES, Long.class);
