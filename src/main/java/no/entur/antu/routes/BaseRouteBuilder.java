...
public abstract class BaseRouteBuilder extends RouteBuilder {
    ...
    public void configure() throws Exception {
        ...
        interceptSendToEndpoint("google-pubsub:*").process(
                exchange -> {
                    ...
                    if (exchange.getIn().getHeader(Constants.CODESPACE) != null) {
                        pubSubAttributes.put(Constants.CODESPACE, exchange.getIn().getHeader(Constants.CODESPACE, String.class));
                    }
    ...
    protected String correlation() {
        return "[codespace=${header." + Constants.CODESPACE + "} correlationId=${header." + Constants.CORRELATION_ID + "}] ";
    }
