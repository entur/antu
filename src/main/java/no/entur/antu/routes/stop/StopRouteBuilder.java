...
public class StopRouteBuilder extends BaseRouteBuilder {
    ...
    public StopRouteBuilder(@Value("${antu.stop.refresh.interval:trigger.repeatCount=2&trigger.repeatInterval=10000}")
    ...
    public void configure() throws Exception {
        ...
        from("master:lockOnAntuRefreshStopCache:quartz://antu/refreshStopPlaceCacheAtStartup?" + "?trigger.repeatCount=0")
