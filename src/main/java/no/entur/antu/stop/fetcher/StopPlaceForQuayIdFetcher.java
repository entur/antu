...
public class StopPlaceForQuayIdFetcher extends AntuNetexEntityFetcher<StopPlace, QuayId> {
    ...
    protected StopPlaceForQuayIdFetcher(@Qualifier("stopPlaceWebClient") WebClient stopPlaceWebClient) {
    ...
    public StopPlace tryFetch(QuayId quayId) {
        ...
        try {
            ...
            throw new AntuException("Failed fetching StopPlace for quay id " + quayId.id() + " due to " + e.getMessage());
        }
    }
}
