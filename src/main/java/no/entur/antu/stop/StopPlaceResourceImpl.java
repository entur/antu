...
public class StopPlaceResourceImpl implements StopPlaceResource {
    ...
    public List<Map.Entry<QuayId, TransportModes>> getQuayTransportModesEntries(StopPlace stopPlace) {
        return makeQuayIdMapEntries(stopPlace, quayId -> Map.entry(
                quayId,
                new TransportModes(
    ...
    public List<Map.Entry<QuayId, StopPlaceCoordinates>> getQuayCoordinatesEntries(StopPlace stopPlace) {
        return makeQuayIdMapEntries(stopPlace, quayId -> {
            StopPlaceCoordinates stopPlaceCoordinates = StopPlaceCoordinates.of(stopPlace);
