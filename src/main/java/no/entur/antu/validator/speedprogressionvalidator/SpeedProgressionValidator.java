...
public class SpeedProgressionValidator extends AbstractNetexValidator {
  ...
  private static final Logger LOGGER = LoggerFactory.getLogger(
    SpeedProgressionValidator.class
  );
  private final CommonDataRepository commonDataRepository;
  private final StopPlaceRepository stopPlaceRepository;

  public SpeedProgressionValidator(
  ...
  private SpeedProgressionError validateSpeedProgression(
    ServiceJourneyContext context,
    ...
    return validateSpeed(
      distance,
      ExpectedSpeed.of(context.transportMode()),
      passingTimes
    );
  }
   ...
   */
  private double calculateSpeedInKilometerPerHour(
  ...
  private SpeedProgressionError validateSpeed(
    double distance,
  ...
  public Set<String> getRuleDescriptions() {
    return Set.of(
      createRuleDescription(
        SpeedProgressionError.RuleCode.LOW_SPEED_PROGRESSION.toString(),
        SpeedProgressionError.RuleCode.LOW_SPEED_PROGRESSION.getErrorMessage()
      ),
      createRuleDescription(
        SpeedProgressionError.RuleCode.HIGH_SPEED_PROGRESSION.toString(),
        SpeedProgressionError.RuleCode.HIGH_SPEED_PROGRESSION.getErrorMessage()
      ),
      createRuleDescription(
        SpeedProgressionError.RuleCode.WARNING_SPEED_PROGRESSION.toString(),
