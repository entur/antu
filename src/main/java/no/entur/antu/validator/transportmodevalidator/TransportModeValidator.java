...
public class TransportModeValidator extends AbstractNetexValidator {
  ...
  private static final String RULE_CODE_NETEX_TRANSPORT_MODE_1 =
    "NETEX_TRANSPORT_MODE_1";
  ...
  public void validate(
    ...
    getServiceJourneys(validationContext)
      ...
      .filter(
        Predicate.not(serviceJourneyContext ->
  ...
  private DataLocation findDataLocation(
    ValidationContext validationContext,
    ...
    return validationContext
      ...
      .stream()
      .filter(localId ->
        localId.getId().equals(serviceJourneyContext.serviceJourneyId())
      )
      .findFirst()
      .map(idVersion ->
        new DataLocation(
