...
public record ExpectedSpeed(long maxSpeed, long warningSpeed, long minSpeed) {
    ...
    private static ExpectedSpeed of(long maxSpeed, long warningSpeed, long minSpeed) {
        return new ExpectedSpeed(maxSpeed, warningSpeed, minSpeed);
    }

    public static ExpectedSpeed of(AllVehicleModesOfTransportEnumeration transportMode) {
        return switch (transportMode) {
            ...
            case INTERCITY_RAIL, URBAN_RAIL, ALL, UNKNOWN, SNOW_AND_ICE, SELF_DRIVE, ANY_MODE -> null;
        };
    }
