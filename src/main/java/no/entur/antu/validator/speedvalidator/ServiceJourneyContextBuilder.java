...
public class ServiceJourneyContextBuilder {
    ...
    public record ServiceJourneyContext(
        ...
        public ServiceJourneyContext(ServiceJourney serviceJourney,
                                     AllVehicleModesOfTransportEnumeration transportMode,
                                     Map<String, StopPlaceCoordinates> stopPlaceCoordinatesPerTimetabledPassingTimeId) {
            this(serviceJourney, transportMode, stopPlaceCoordinatesPerTimetabledPassingTimeId, new DistanceCalculator());
        }
        ...
        private StopPlaceCoordinates getCoordinates(StopTime passingTime) {
            return stopPlaceCoordinatesPerTimetabledPassingTimeId.get(passingTime.timetabledPassingTimeId());
        }

        public boolean hasValidCoordinates(PassingTimes passingTimes) {
            return getCoordinates(passingTimes.from()) != null && getCoordinates(passingTimes.to()) != null;
        }
    }
    ...
    public ServiceJourneyContextBuilder(CommonDataRepository commonDataRepository,
                                        StopPlaceRepository stopPlaceRepository) {
        this.commonDataRepository = commonDataRepository;
        this.stopPlaceRepository = stopPlaceRepository;
    }

    public ServiceJourneyContext build(NetexEntitiesIndex index, ServiceJourney serviceJourney, String validationReportId) {
    ...
    private AllVehicleModesOfTransportEnumeration findTransportMode(NetexEntitiesIndex index,
                                                                    ServiceJourney serviceJourney) {
