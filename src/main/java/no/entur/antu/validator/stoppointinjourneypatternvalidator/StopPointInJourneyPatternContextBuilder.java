...
public class StopPointInJourneyPatternContextBuilder {
  ...
  public record StopPointInJourneyPatternContext(JourneyPattern journeyPattern, // trenger bare ID?
                                                 StopPointInJourneyPattern stopPointInJourneyPattern, QuayId quayId) {}
  ...
  public List<StopPointInJourneyPatternContext> build(
    ...
    return journeyPattern.getPointsInSequence()
      ...
      .map(stopPointInJourneyPattern -> new StopPointInJourneyPatternContext(journeyPattern,
        stopPointInJourneyPattern,
        commonDataRepository.findQuayIdForScheduledStopPoint(stopPointInJourneyPattern.getScheduledStopPointRef()
            .getValue()
            .getRef(),
          validationReportId)))
      .toList();
