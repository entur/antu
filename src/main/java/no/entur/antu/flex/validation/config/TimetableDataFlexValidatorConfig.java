...
import no.entur.antu.flex.validation.validator.flexibleareavalidator.FlexibleAreaValidator;
...
public class TimetableDataFlexValidatorConfig {
  ...
  @Bean
  public FlexibleAreaValidator flexibleAreaValidator(
    @Qualifier(
      "validationReportEntryFactory"
    ) ValidationReportEntryFactory validationReportEntryFactory
  ) {
    return new FlexibleAreaValidator(validationReportEntryFactory);
  }
