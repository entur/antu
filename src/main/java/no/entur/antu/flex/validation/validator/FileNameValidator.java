...
public class FileNameValidator extends AbstractNetexValidator {
    ...
    protected static final String RULE_CODE_NETEX_FILE_NAME_1 = "NETEX_FILE_NAME_1";
    private static final Pattern SHARED_FILE_PATTERN = Pattern.compile("_(\\w{3})(_flexible)?_shared_data.xml");
    private static final Pattern LINE_FILE_PATTERN = Pattern.compile("(\\w{3})_.*\\.xml");

    public FileNameValidator(ValidationReportEntryFactory validationReportEntryFactory) {
