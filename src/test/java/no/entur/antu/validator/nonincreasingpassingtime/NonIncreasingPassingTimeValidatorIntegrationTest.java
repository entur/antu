...
class NonIncreasingPassingTimeValidatorIntegrationTest {
    ...
    public static final String TEST_FILE_VALID = "FLB_FLB-Line-42_42_Flamsbana.xml";
    public static final String TEST_FILE_VALID_INVALID = "FLB_FLB-Line-42_42_Flamsbana_non_increasing_passing_time.xml";
    ...
    void testInValidIncreasingPassingTime() throws IOException {
        ValidationReport validationReport = getValidationReport(TEST_FILE_VALID_INVALID);
    ...
    private ValidationReport getValidationReport(String testFile) throws IOException {

        ValidationReport testValidationReport = new ValidationReport(TEST_CODESPACE, "Test1122");

        try (InputStream testDatasetAsStream = getClass().getResourceAsStream('/' + testFile)) {
            assert testDatasetAsStream != null;
            NetexEntitiesIndex netexEntitiesIndex = NETEX_PARSER.parse(testDatasetAsStream);
            ...
            NonIncreasingPassingTimeValidator nonIncreasingPassingTimeValidator = new NonIncreasingPassingTimeValidator(
