...
class MismatchedTransportModeValidatorTest {
  ...
  static class TestData {
    ...
    private static final ScheduledStopPointId SCHEDULED_STOP_POINT_REF =
      new ScheduledStopPointId("TST:ScheduledStopPoint:default-11605");
    private static final ScheduledStopPointId SCHEDULED_STOP_POINT_REF_2 =
      new ScheduledStopPointId("TST:ScheduledStopPoint:default-11134");
  ...
  void railReplacementBusStopsCanOnlyBeVisitedByRailReplacementBusService() {
    ...
    assertThat(
      ...
      is(Optional.of("INVALID_TRANSPORT_SUB_MODE"))
    );
    assertThat(
      validationReport
        .getValidationReportEntries()
      ...
      is(
        Optional.of(
          "Invalid transport sub mode. Expected railReplacementBus, was expressBus."
        )
      )
    );
  }
  ...
  void taxiCannotStopOnStopOtherThanBusOrCoach() {
    ...
    assertThat(
      validationReport
        ...
        .findFirst()
        .map(ValidationReportEntry::getMessage),
      is(Optional.of("Invalid transport mode. Expected metro, was taxi."))
    );
  }
  ...
  void transportModeMissMatchShouldGenerateValidationEntry() {
    ...
    assertThat(
      validationReport
        ...
        .findFirst()
        .map(ValidationReportEntry::getMessage),
      is(Optional.of("Invalid transport mode. Expected rail, was metro."))
    );
  }
