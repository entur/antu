...
public class TestNetexDataRepository implements NetexDataRepositoryLoader {
  ...
  public void addServiceJourneyInterchangeInfo(
    String validationReportId,
    ServiceJourneyInterchangeInfo serviceJourneyInterchangeInfo
  ) {
    ArrayList<ServiceJourneyInterchangeInfo> serviceJourneyInterchangeInfoList =
      new ArrayList<>();
    if (this.serviceJourneyInterchangeInfos == null) {
      ...
      this.serviceJourneyInterchangeInfos.put(
          validationReportId,
          serviceJourneyInterchangeInfoList
        );
    } else if (
      this.serviceJourneyInterchangeInfos.containsKey(validationReportId)
    ) {
      this.serviceJourneyInterchangeInfos.get(validationReportId)
  ...
  public void putServiceJourneyIdToActiveDates(
    ...
    Map.Entry<String, Map<ServiceJourneyId, List<LocalDateTime>>> entry =
      Map.entry(validationReportId, serviceJourneyIdToActiveDates);
    if (this.serviceJourneyIdToActiveDatesByValidationReportId == null) {
      ...
      this.serviceJourneyIdToActiveDatesByValidationReportId.put(
          validationReportId,
          entry.getValue()
        );
      return;
  ...
  public void putServiceJourneyStop(
    String validationReportId,
    Map<ServiceJourneyId, List<ServiceJourneyStop>> serviceJourneyStops
  ) {
    Map.Entry<String, Map<ServiceJourneyId, List<ServiceJourneyStop>>> entry =
      Map.entry(validationReportId, serviceJourneyStops);
